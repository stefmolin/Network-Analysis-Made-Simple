...
```
    ...
    <matplotlib.collections.PathCollection at 0x7f450ceec250>
...
```
    ...
    <matplotlib.collections.PathCollection at 0x7f450cdb29d0>
...
```
    ...
    <matplotlib.collections.PathCollection at 0x7f450cb83130>
...
```
    ...
    (0.8160427807486625, 0.5368983957219238)
